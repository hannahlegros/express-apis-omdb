...
const { route } = require('./omdbRoutes')
...
router.delete('/:id', (req, res) =>{
    ...
    .then(deletedItem =>{
        // destroy returns '1' if something was deleted and '0' if nothing was deleted
...
// if you're using a request parameter(:id in this case) make sure your more specific URLs are above the one using the parameter
